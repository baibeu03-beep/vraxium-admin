...
//
//   size="default" → 모바일 32px · 데스크톱 40px  ← 일반 주요 섹션 스택
//   size="lg"      → 모바일 40px · 데스크톱 48px  ← 페이지 전체를 이루는 큰 섹션 묶음(허브/탭 등)
//   (섹션 간 세로 리듬을 전역으로 약 2배 확대. 실제 gap 값은 globals.css @utility 가 SoT)
//
