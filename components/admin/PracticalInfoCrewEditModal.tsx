...
export default function PracticalInfoCrewEditModal({
        ...
        <div className="space-y-3">
          <dl className="space-y-1.5 rounded-md border bg-muted/30 px-3 py-2 text-sm">
            <div className="flex gap-2">
              <dt className={DETAIL_ROW_LABEL_CLASS}>주차</dt>
              <dd className="font-medium">{weekLabel}</dd>
            </div>
            <div className="flex gap-2">
              <dt className={DETAIL_ROW_LABEL_CLASS}>라인</dt>
              <dd className="font-medium">{lineName}</dd>
            </div>
            <div className="flex gap-2">
              <dt className={DETAIL_ROW_LABEL_CLASS}>반영 방식</dt>
              <dd className="font-medium">
                {editMode === "add" ? "기존 유지 + 추가" : "전체 교체"}
              </dd>
            </div>
            <div className="flex gap-2">
              <dt className={DETAIL_ROW_LABEL_CLASS}>검수 크루</dt>
              <dd className="font-medium">{candidates.length}명</dd>
            </div>
            <div className="flex gap-2">
              <dt className={DETAIL_ROW_LABEL_CLASS}>제외</dt>
              <dd className="font-medium text-red-600">{removalPreview.length}명</dd>
            </div>
            <div className="flex gap-2">
              <dt className={DETAIL_ROW_LABEL_CLASS}>저장 후 대상</dt>
  ...
  return (
    <div data-admin-overlay="" className="fixed inset-0 z-modal flex items-center justify-center admin-backdrop p-4 sm:p-8">
      <div
